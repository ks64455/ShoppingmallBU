...
<script type="text/javascript"
	src="/shoppingmall/mngr/orderedProduct/orderlist.js"></script>
			...
			<table>
				...
				<c:forEach var="i" begin="0" end="${buyLists.size()-1 }">
					...
					<tr>
						...
						<td>${buyList.getDeliverySanction()}</td>
					</tr>

					<c:if test="${pid != null }">
					<tr><td colspan="12" class="b">주문금액 :<fmt:formatNumber value="${total}" type="number" pattern="#,##0"/>원</td></tr>
					<c:set var="total" value="0"/>
