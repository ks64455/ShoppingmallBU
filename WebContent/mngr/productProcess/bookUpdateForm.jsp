		...
		<div id="bookUpdateForm" class="box">
			<ul>
				...
				<li><label for="book_image">책 이미지</label> <input
					id="book_image" name="book_image" type="file">${book.book_image}</li>
				<li><label for="book_content">내용</label> <textarea
						id="book_content" name="book_content" rows="13" cols="50">${book.book_content}</textarea></li>
				<li><label for="discount_rate">할인율</label> <input
					id="discount_rate" name="discount_rate" type="text" size="5"
					value="${discount_rate}" maxlength="2"></li>
